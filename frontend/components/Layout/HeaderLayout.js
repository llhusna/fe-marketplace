  ...
  return (
    ...
    <header className='grid md:grid-cols-1 px-4 lg:px-10 py-2'>
        <div className='flex justify-between items-center'>
            <div>
                <Link to="/">
                <img className="w-10 lg:w-12" src={images.logofooter} />
                </Link>
            </div>
         ...
         {/* <button className='bg-white text-red-600 text-xs py-2 px-4'>Rainbow Bridge</button> */}
            <a
              className="bg-white text-red-600 px-[0.5em] lg:px-[0.75em] py-[0.5em] lg:py-[0.8em] rounded-md"
              href="https://rainbowbridge.app/transfer"
            >
              <span className="flex">
                <img className="mr-2 w-4 lg:w-6" src={images.rainbow}></img>
                <span className="text-[10px] lg:text-xs">Rainbow bridge</span>
              </span>
            </a>
                <div>
